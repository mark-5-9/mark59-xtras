...
import com.mark59.datahunter.functionalTest.dsl.pages.AddPolicyActionPage;
import com.mark59.datahunter.functionalTest.dsl.pages.AddPolicyPage;
import com.mark59.datahunter.functionalTest.dsl.pages.AsyncMessageAnalyzerActionPage;
import com.mark59.datahunter.functionalTest.dsl.pages.AsyncMessageAnalyzerPage;
import com.mark59.datahunter.functionalTest.dsl.pages.CountPoliciesActionPage;
import com.mark59.datahunter.functionalTest.dsl.pages.CountPoliciesBreakdownActionPage;
import com.mark59.datahunter.functionalTest.dsl.pages.CountPoliciesBreakdownPage;
import com.mark59.datahunter.functionalTest.dsl.pages.CountPoliciesPage;
import com.mark59.datahunter.functionalTest.dsl.pages.DeleteMultiplePoliciesActionPage;
import com.mark59.datahunter.functionalTest.dsl.pages.DeleteMultiplePoliciesPage;
import com.mark59.datahunter.functionalTest.dsl.pages.DeletePolicyActionPage;
import com.mark59.datahunter.functionalTest.dsl.pages.DeletePolicyPage;
import com.mark59.datahunter.functionalTest.dsl.pages.NextPolicyActionPage;
import com.mark59.datahunter.functionalTest.dsl.pages.NextPolicyPage;
import com.mark59.datahunter.functionalTest.dsl.pages.PrintSelectedPoliciesActionPage;
import com.mark59.datahunter.functionalTest.dsl.pages.PrintSelectedPoliciesPage;
import com.mark59.datahunter.functionalTest.dsl.pages.SuperDataHunterActionPage;
import com.mark59.datahunter.functionalTest.dsl.pages.UpdatePoliciesUseStateActionPage;
import com.mark59.datahunter.functionalTest.dsl.pages.UpdatePoliciesUseStatePage;
...
public class DslPageFunctions  implements Serializable {
	...
	public Integer countPoliciesForBreakdown(String application, String lifecycle, String useability, WebDriver driver) {
		...
		if (useability != null && !useability.isEmpty()) {
	...
	public Integer deleteMultiplePolicies(PolicySelectionCriteria policySelectionCriteria, WebDriver driver) {
		...
		if (policySelectionCriteria.getUseability() != null && !(policySelectionCriteria.getUseability().isEmpty())){			
